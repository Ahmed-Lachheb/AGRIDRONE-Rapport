...
\begin{figure}[H] 
	\begin{center} 
		\centering
		\hspace*{-1.7cm}	\fbox{\includegraphics[width=1.23\linewidth]{Images/Diagramme de définition de bloc}}
	\end{center}
	...
	\begin{figure}[H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.53\linewidth]{Images/Choix du type de quadrirotor}}
		\end{center}
	...
	\begin{figure}[H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.53\linewidth]{Images/calibration du magnétométre}}
		\end{center}
