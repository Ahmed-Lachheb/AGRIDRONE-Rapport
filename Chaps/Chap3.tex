...
\begin{figure} [H]
	\begin{center}
		\centering
		\vskip 1cm
		\fbox{\includegraphics[width=0.9\textwidth]{Images/Emetteur radiocommande}}
	\end{center}
	\caption{Turnigy 9x}
\end{figure}
...
\section{Diagramme de définition  de bloc  }
...
\begin{figure}[H] 
	\begin{center} 
		\centering
		\hspace*{-0.65cm}	\fbox{\includegraphics[width=1.15\linewidth]{Images/Diagramme de définition de bloc}}
	\end{center}
	...
	\begin{figure}[h]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.7\linewidth]{Images/Jira}}
		\end{center}
	...
	\begin{figure}[H]
		\begin{center}
			\centering
			\vskip 1cm
			\fbox{\includegraphics[width=0.7\linewidth]{Images/Platforme de JabRef}}
		\end{center}
	...
	\begin{figure}[H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.62\linewidth]{Images/Choix du type de quadrirotor}}
		\end{center}
	...
	\begin{figure}[H]
		\begin{center}
			\centering
			\vskip 1cm
			\fbox{\includegraphics[width=0.62\linewidth]{Images/calibration du magnétométre}}
		\end{center}
	...
	\begin{figure} [H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.65\linewidth]{Images/calibaration du radio}}
		\end{center}
	...
	\begin{figure} [H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.9\linewidth]{Images/Modes de vol}}
		\end{center}
	...
	\begin{figure} [H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.9\linewidth]{Images/PID APM 2.8}}
		\end{center}
	...
	\begin{figure}[H]
		\begin{center}
			\centering
			\fbox{\includegraphics[width=0.65\linewidth]{Images/Inversion des servos}}
		\end{center}
