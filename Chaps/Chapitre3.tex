...
\lfoot{Chapitre3: Réalisation du projet}
\rfoot{\thepage}
...
\begin{figure}[h]
	\begin{center}
		\centering
		\fbox{\includegraphics[width=0.6\linewidth]{Images/papyrus}}
	\end{center}
	\caption{Les 4 modes}
\end{figure}
\newpage
...
\begin{figure}[h]
	\begin{center}
		\centering
		\fbox{\includegraphics[width=0.6\linewidth]{Images/Visual Paradigm}}
	\end{center}
	\caption{Les 4 modes}
\end{figure}
...
\begin{figure}[h]
	\begin{center}
		\centering
		\fbox{\includegraphics[width=0.6\linewidth]{Images/Companion 9x}}
	\end{center}
	\caption{Les 4 modes}
\end{figure}
\newpage
...
\begin{figure}[h]
	\begin{center}
		\centering
       \fbox{ \includegraphics[width=0.8\linewidth]{Images/Chargement du firmware}}
	\end{center}
	\caption{Les 4 modes}
\end{figure}
...
\begin{table}[h]
	\begin{center}
		...
		\begin{tabular}{|c|c|}
			...
			\includegraphics[width=4.8cm]{C:/Users/Ahmed Baha eddine/Downloads/Mode 1(Radiocommande)} & \includegraphics[width=4.8cm]{C:/Users/Ahmed Baha eddine/Downloads/Mode 2(Radiocommande)}\\
			\hline
			\centering
			...
			\hline
			\centering
			\includegraphics[width=4.69999cm]{C:/Users/Ahmed Baha eddine/Downloads/Mode 3(Radiocommande)}& \includegraphics[width=4.69999cm]{C:/Users/Ahmed Baha eddine/Downloads/Mode 4(Radiocommande)}\\
			\hline
			\centering
...
\begin{figure}[h]
	\begin{center}
		\centering
		\fbox{\includegraphics[width=0.6\linewidth]{C:/Users/Ahmed Baha eddine/Downloads/Green-128}}
	\end{center}
