...
Il existe plusieurs types de drones, nous avons mis l'accent sur deux types: aile fixe et multirotor.
 ...
 \fbox{	\includegraphics[width=0.6\linewidth]{Images/Ailes fixed}}
	...
	\begin{table}[H]
		\begin{center}
			\caption{Comparaison entre un drone aile fixe  et un drone multirotors }
			\begin{tabular}{|c|c|c|}
				\hline
				\centering
				& 
...
\fbox{\includegraphics[width=0.6\linewidth]{Images/Sens de rotation des moteurs}}	
	...
	\begin{itemize}
		\item \textbf{Mouvement vertical}
		\item \textbf{Mouvement de roulis} 
		\item \textbf{Mouvement de tangage}
		\item \textbf {Mouvement de lacet}
	\end{itemize}
	\begin{figure} [H]
	\begin{center}
		\centering
