...
\end{figure}
	...
	\begin{itemize}
		...
		\hspace*{-1.3cm} \fbox{\includegraphics[width=1.26\linewidth]{Images/Diagramme d'exigence}}
			...
			\section[Diag.cas d'utilisation]{Diagrammes des cas d'utilisation }\label{Cas d'utilisation}
			...
			\begin{center}
			\centering
			\hspace*{-0.8cm}\fbox{\includegraphics[width=1.3\linewidth]{Images/Diagramme de cas d'utilisation globale}}
			\end{center}
