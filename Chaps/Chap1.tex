...
\begin{itemize}
	...
	\begin{figure}[H] 
		\begin{center} 
			\centering
			\hspace*{-1.3cm} \fbox{\includegraphics[width=1.2\linewidth]{Images/Diagramme d'exigence}}
		...
		\begin{center}
			\centering
			\hspace*{-1.2cm}\fbox{\includegraphics[width=1.2\linewidth]{Images/Diagramme de cas d'utilisation globale}}
		\end{center}
		...
		\begin{figure}[H] 
			\begin{center} 
				\centering
				\hspace*{0cm}	\fbox{\includegraphics[width=1\linewidth]{Images/Diagramme de cas d'utilisation agriculture}}
			\end{center}
