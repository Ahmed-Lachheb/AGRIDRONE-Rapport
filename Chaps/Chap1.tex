...
La conception des systèmes mécatroniques suit le langage de modélisation SysML (System Modeling Language). Qui est le langage de modélisation universel lors de la modélisation des systèmes mécatroniques \corrg{[https://tel.archives-ouvertes.fr/tel-00336839]}. C'est pourquoi nous exploiterons les diagrammes des exigences et des cas d'utilisation afin de présenter notre cahier de charges final dans la dernière section de ce chapitre.
